...
ui <- fluidPage(theme=shinytheme("superhero"),
                navbarPage(
                  ...
                  tabPanel("Programming Languages",
                           titlePanel("What are Programming Languages?"),
                 ...
                 It is better to learn the languages that are currently in trend so you do not stuck with old technology! "),
                  ...
                  tabPanel("Variables",
                           ...
                           br(),
                           img(src = "main.png", height = 130, width = 400),
                           p("ㅤ"),
                           tags$style("
                  #main * {  
                      display: inline;
                  ...
                  #helloworld * {  
                      display: inline;
                           ...
                           img(src = "image2.png", height = 150, width = 750),
                           p("ㅤ"),
                  ...
                  tabPanel("Operators",
                           ...
                           tags$h3("Arithmetic operators", style="color:fuchsia"),
                           img(src = "image3.png", height = 250, width = 700),
                           p("ㅤ"),
                           p("Arithmetic operators are used to perform common mathematical operations."),
                           p("In the table above, we covered arithmetic operators. There are different kinds of operators."),
                           tags$h3("Assignment operators", style="color:fuchsia"),
                           img(src = "image4.png", height = 450, width = 725),
                           p("ㅤ"),
                           p("Assignment operators are used to assign values to variables."),
                           tags$h3("Comparison operators", style="color:fuchsia"),
                           img(src = "image5.png", height = 300, width = 725),
                           p("ㅤ"),
                           p("Comparison operators are used to compare two values."),
                           tags$h3("Logical operators", style="color:fuchsia"),
                           img(src = "image6.png", height = 150, width = 725),
                           p("ㅤ"),
                           p("Logical operators are used to determine the logic between variables or values"),
                           br(),
                           tags$h3("Time for some questions!"),
                           sidebarPanel(
                             tags$h3("int x = 10 % 5;"),
                  ...
                  tabPanel("If-else",
                           ...
                           tags$div(
                             ...
                             img(src = "image7.png", height = 85, width = 500),
                             br(),
                             tags$h3("The else statement", style="color:blue"),
                             img(src = "image8.png", height = 130, width = 500),
                             br(),
                             tags$h3("The else-if statement", style="color:blue"),
                             img(src = "image9.png", height = 185, width = 680),
                             br(),
                             ...
                             img(src = "image10.png", height = 50, width = 500),
                             br(),
                             br(),
                             tags$h3("Time for some questions!"),
                             sidebarPanel(
                               img(src = "ifelse.png", height = 400, width = 420),
                               tags$h4("What is the output that would be printed"),
                  ...
                  tabPanel("do-while",
                           ...
                           br(),
                           img(src = "image11.png", height = 100, width = 300),
                           p("ㅤ"),
                           ...
                           br(),
                           img(src = "image12.png", height = 125, width = 300),
                           p("ㅤ"),
                           ...
                           tags$h3("Time for some questions!"),
                           sidebarPanel(
                             img(src = "while.png", height = 400, width = 420),
                             tags$h4("What is the value of 'sum' that would be printed?"),
                             textInput("ansp4q1","your answer",""),
                             submitButton("Submit Answer", icon("share-square")),
                             width = 7,
                           ),
                           mainPanel(
                             h5("Output"),
                             verbatimTextOutput("txtp4q1")
                           )
                  ),
                  tabPanel("for loop",
                           ...
                           br(),
                           img(src = "image13.png", height = 120, width = 400),
                           p("ㅤ"),
                           ...
                           tags$h3("Time for some questions!"),
                           sidebarPanel(
                             img(src = "for.png", height = 375, width = 420),
                             tags$h4("What is the value of 'x' that would be printed?"),
                             textInput("ansp5q1","your answer",""),
                             submitButton("Submit Answer", icon("share-square")),
                             width = 7,
                           ),
                           mainPanel(
                             h5("Output"),
                             verbatimTextOutput("txtp5q1")
                           )
                  ),
                  tabPanel("Quiz",
...
server <- function(input,output){
  ...
  prog_lang <- read.csv("Most Popular Programming Languages from 2004 to 2021 V4.csv")
  ...
  output$txtp3q1 <- renderText({
    if (input$ansp3q1 == "") {
      ""
    }else if (input$ansp3q1 == "onetwo"){
      "That's correct!"
    } else if (input$ansp3q1 == "one" || input$ansp3q1 == "two" || input$ansp3q1 == "one two"){
      "That's not correct, but you're close!"
    }
    else {
      "Sorry, but that's not correct. Try again."
    }
  })
  
  output$txtp4q1 <- renderText({
    if (input$ansp4q1 == "") {
      ""
    }else if (input$ansp4q1 == "21"){
      "That's correct!"
    } else {
      "Sorry, but that's not correct. Try again."
    }
  ...
  output$txtp5q1 <- renderText({
    if (input$ansp5q1 == "") {
      ""
    }else if (input$ansp5q1 == "1"){
      "That's correct!"
    } else {
      "Sorry, but that's not correct. Try again."
    }
